...
```console
$ docker run -d --name some-ghost -p 3001:2368 -v /path/to/ghost/blog:/var/lib/ghost/content winamd64/ghost:alpine
```
...
```console
$ docker run -d --name some-ghost -v some-ghost-data:/var/lib/ghost/content winamd64/ghost
```
