...
**Note:** this is the "per-architecture" repository for the `arm64v8` builds of [the `friendica` official image](https://hub.docker.com/_/friendica) -- for more information, see ["Architectures other than amd64?" in the official images documentation](https://github.com/docker-library/official-images#architectures-other-than-amd64) and ["An image's source changed in Git, now what?" in the official images FAQ](https://github.com/docker-library/faq#an-images-source-changed-in-git-now-what).
...
-	[`2021.01-apache`, `2021.01`](https://github.com/friendica/docker/blob/88db303a9ad22024d505b28390af384e28a5a624/2021.01/apache/Dockerfile)
-	[`2021.01-fpm`](https://github.com/friendica/docker/blob/88db303a9ad22024d505b28390af384e28a5a624/2021.01/fpm/Dockerfile)
-	[`2021.01-fpm-alpine`](https://github.com/friendica/docker/blob/88db303a9ad22024d505b28390af384e28a5a624/2021.01/fpm-alpine/Dockerfile)
-	[`2021.04-apache`, `apache`, `stable-apache`, `2021.04`, `latest`, `stable`](https://github.com/friendica/docker/blob/9e22de455afc8ba9a39b3b17316f613e2b4d0df8/2021.04/apache/Dockerfile)
-	[`2021.04-fpm`, `fpm`, `stable-fpm`](https://github.com/friendica/docker/blob/9e22de455afc8ba9a39b3b17316f613e2b4d0df8/2021.04/fpm/Dockerfile)
-	[`2021.04-fpm-alpine`, `fpm-alpine`, `stable-fpm-alpine`](https://github.com/friendica/docker/blob/9e22de455afc8ba9a39b3b17316f613e2b4d0df8/2021.04/fpm-alpine/Dockerfile)
...
[![arm64v8/friendica build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/friendica.svg?label=arm64v8/friendica%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/friendica/)
...
```console
$ docker run -d -p 8080:80 --network some-network arm64v8/friendica
```
...
```console
$ docker run -d arm64v8/friendica:fpm
```
...
You have to pull the latest image from the hub (`docker pull arm64v8/friendica`). The stable branch gets checked at every startup and will get updated if no installation was found or a new image is used.
...
The `arm64v8/friendica` images come in many flavors, each designed for a specific use case.

## `arm64v8/friendica:<version>`

This is the defacto image. If you are unsure about what your needs are, you probably want to use this one. It is designed to be used both as a throw away container (mount your source code and start the container to start your app), as well as the base to build other images off of.

## `arm64v8/friendica:<version>-alpine`
