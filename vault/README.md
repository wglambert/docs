...
**Note:** this is the "per-architecture" repository for the `arm32v6` builds of [the `vault` official image](https://hub.docker.com/_/vault) -- for more information, see ["Architectures other than amd64?" in the official images documentation](https://github.com/docker-library/official-images#architectures-other-than-amd64) and ["An image's source changed in Git, now what?" in the official images FAQ](https://github.com/docker-library/faq#an-images-source-changed-in-git-now-what).
...
-	[`1.7.2`, `latest`](https://github.com/hashicorp/docker-vault/blob/0faaebde27532dbe32ec9be3199ceaa705e3e662/0.X/Dockerfile)
