...
[![i386/almalinux build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/i386/job/almalinux.svg?label=i386/almalinux%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/almalinux/)
...
The `i386/almalinux:latest` tag will always point to the latest stable release. Major releases are also tagged with their version (e.g. `i386/almalinux:8`). All images for supported releases will be updated monthly or as needed for security fixes.
