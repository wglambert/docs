...
The `s390x/almalinux:latest` tag will always point to the latest stable release. Major releases are also tagged with their version (e.g. `s390x/almalinux:8`). All images for supported releases will be updated monthly or as needed for security fixes.
