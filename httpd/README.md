...
**Note:** this is the "per-architecture" repository for the `ppc64le` builds of [the `httpd` official image](https://hub.docker.com/_/httpd) -- for more information, see ["Architectures other than amd64?" in the official images documentation](https://github.com/docker-library/official-images#architectures-other-than-amd64) and ["An image's source changed in Git, now what?" in the official images FAQ](https://github.com/docker-library/faq#an-images-source-changed-in-git-now-what).
...
-	[`2.4.48-alpine`, `2.4-alpine`, `2-alpine`, `alpine`](https://github.com/docker-library/httpd/blob/8835b23f748f80bcec510c14b68c84bc37767cdb/2.4/alpine/Dockerfile)
...
```console
$ docker run --rm ppc64le/httpd:2.4 cat /usr/local/apache2/conf/httpd.conf > my-httpd.conf
```
